...
Scalement.prototype.draw = function (context) {
    if (!this.alive.size || !this.w.curr || !this.h.curr) return;

    if (this.w.curr !== 1 || this.h.curr !== 1) context.scale(this.w.curr, this.h.curr);

    Group.prototype.draw.call(this, context);

    if (this.w.curr !== 1 || this.h.curr !== 1) context.scale(1 / this.w.curr, 1 / this.h.curr);
};
//# sourceMappingURL=scalement.js.map