...
class Reactant {
    ...
    /*
     * Registers a callback function to be called every time the value of this reactant changes. The
     * parameters are the previous value of this reactant followed by the current value.
     * Example:
     ...
     * a.value = 8 //prints 4, 8
     */
    listen_pc(callback:(previous:any, current:any)=>void) {
