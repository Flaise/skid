...
describe('Is', function() {
    ...
    it('string', function() {
        expect(is.string(function() {})).toBe(false)
        expect(is.string(is.function)).toBe(false)
        expect(is.string(setTimeout)).toBe(false)
        expect(is.string(true)).toBe(false)
        expect(is.string(false)).toBe(false)
        expect(is.string({})).toBe(false)
        expect(is.string([])).toBe(false)
        expect(is.string([1, 2])).toBe(false)
        expect(is.string({a: 3})).toBe(false)
        expect(is.string(9)).toBe(false)
        expect(is.string(0)).toBe(false)
        expect(is.string(-30)).toBe(false)
        expect(is.string(.1)).toBe(false)
        expect(is.string(-.1)).toBe(false)
        expect(is.string('')).toBe(true)
        expect(is.string('asdf')).toBe(true)
    ...
    it('iterable', function() {
        expect(is.iterable(function() {})).toBe(false)
        expect(is.iterable(is.function)).toBe(false)
        expect(is.iterable(setTimeout)).toBe(false)
        expect(is.iterable(true)).toBe(false)
        ...
        expect(is.iterable({a: 3})).toBe(false)
        expect(is.iterable(9)).toBe(false)
        expect(is.iterable(0)).toBe(false)
        expect(is.iterable(-30)).toBe(false)
        expect(is.iterable(.1)).toBe(false)
        expect(is.iterable(-.1)).toBe(false)
        expect(is.iterable('')).toBe(true)
        expect(is.iterable('asdf')).toBe(true)
        expect(is.iterable(NaN)).toBe(false)
        expect(is.iterable(Infinity)).toBe(false)
        expect(is.iterable(-Infinity)).toBe(false)
